    ...
    <div className="flex flex-wrap text-left lg:text-left">
      <div className="w-full lg:w-6/12 px-4">
        ...
        <h5 className="text-lg mt-4 mb-2 text-blueGray-600">
          <span className='font-bold'>Address:</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio minus ea corporis deleniti dolore. Vitae odit aperiam sint natus cum, itaque quis sapiente ab ullam animi ipsa, saepe harum a. Natus, libero.
        </h5>
